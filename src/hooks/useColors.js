...
const useColors = () => {
    ...
    const tabsColors = [useColorModeValue("green.400", "green.800"), useColorModeValue("purple.500", "purple.800"), useColorModeValue("blue.400", "blue.800"), useColorModeValue("orange.400", "orange.800")];
    const tabsBgColors = [useColorModeValue("rgb(159, 218, 167)", "green.600"), useColorModeValue("purple.200", "purple.600"), useColorModeValue("blue.200", "blue.600"), useColorModeValue("orange.200", "orange.600")];
